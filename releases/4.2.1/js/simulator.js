	...
	init: function() { // Initalizes this tab
		...
		$("#get-links").click(function() {
			var chain = Field.mapToString(),
			    url = "http://www.puyonexus.com/chainsim/",
				query    = "?", // Query string
...
Tabs.Settings = {
	init: function() { // Initalizes this tab
		...
		(function() {
			...
			$("#character-background-game").text(Content.Field.EyeCandy.CharacterBackgrounds[0].name);
			$("#character-background-character").text(Content.Field.EyeCandy.CharacterBackgrounds[0].backgrounds[0]);
			$("#character-background .dropdown-menu li[data-id='0']").addClass("selected");
		}());
		...
		EyeCandy: {
			...
			CharacterBackgrounds: [
				...
				},
				{
					...
					backgrounds: [
						"Amitie", "Raffine", "Sig", "Rider",
						"Klug", "Accord", "Oshare Bones", "Yu & Rei",
						"Ocean Prince", "Onion Pixy", "Dongurigaeru", "Lemres",
				...
				},
				{
					...
					backgrounds: [
						"Accord", "Amitie", "Arle", "Black Sig",
						"Carbuncle", "Dongurigaeru", "Draco", "Ecolo",
						"Feli", "Klug", "Lemres", "Maguro",
						"Ocean Prince", "Onion Pixy", "Raffine", "Red Amitie",
						"Rider", "Ringo", "Risukuma", "Rulue",
				...
				},
				{
					...
					backgrounds: [
						...
						"Ecolo", "Ess", "Ex", "Feli",
						"Jay & Ellie", "Klug", "Lemres", "Maguro",
						"O", "Raffine", "Ringo", "Risukuma",
