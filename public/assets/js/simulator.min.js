...
var Simulation = {
	...
	back: function() { // Stops the chain
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#field-cleared").text('0');
		...
		if (this.action === 0) { // Preform the chain
			...
			if (chainMade) { // Has a chain been made?
				...
				if (this.skipMode) { // If we are in skip mode, move directly onto the next step of the chain
					...
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#field-cleared").text(clearedChain + ' (' + clearedTotal + ')');
...
var Tabs = {
	display: function() { // Displays the tab content and initalizes all of the tabs
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#simulator-tabs-select > li a[data-target='#" + (localStorage.getItem("chainsim.lastTab") || "tab-share") + "']").click();
